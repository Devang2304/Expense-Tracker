...
import { getAllTransactions,deleteTransaction,editTransection,addTransaction } from "../api/api";
  ...
  useEffect(() => {
    const getAll = async () => {
      try {
        ...
        const res=await getAllTransactions(data);
